...
namespace MomesCare.Api.Controllers
{
    ...
    {
        private readonly BabyServices service;

        public BabyController(BabyServices _service)
        {
        ...
        [HttpPost]
        [Route("create")]
        public async Task<ActionResult<BaseResponse>> create(BabyCreate model)
        {
            try
            {
        ...
        [HttpPut]
        [Route("update")]
        public async Task<ActionResult<BaseResponse>> update(BabyUpdate model)
        {
        ...
        [HttpGet]
        [Route("getOne")]
        public async Task<ActionResult<BaseResponse>> getOne(int BabyId)
        {
            try
            {
                var response = await this.service.getOne(BabyId);
                return Ok(new BaseResponse { Result = response });
            }
            catch (Exception ex)
            {
