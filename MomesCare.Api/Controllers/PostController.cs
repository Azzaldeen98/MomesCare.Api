...
namespace MomesCare.Api.Controllers
{
    ...
    {
        private readonly PostServices service;

        public PostController(PostServices postServices)
        {
            this.service = postServices;
        }
        ...
        [HttpPost]
        [Route("create")]
        public async Task<ActionResult<BaseResponse>> create(PostCreate model)
        {
            try
            {
        ...
        [HttpPut]
        [Route("update")]
        public async Task<ActionResult<BaseResponse>> update(PostUpdate model)
        {
            try
            {
        ...
        [HttpGet]
        [Route("getPost")]
        public async Task<ActionResult<BaseResponse>> getPost(int id)
        {
            try
            {
